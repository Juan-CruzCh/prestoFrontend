...
import type { UpdateUsuarioI, UsuarioCrearI, UsuarioListarI } from "../interface/usuario";
import { useEstadoModal } from "../../../core/utils/useEstadoModalUtil";
import { actualizarUsuario } from "../service/usuarioService";
...
export const EdiatarUsuarioModal = ({ usuario }: { usuario: UsuarioListarI }) => {
    ...
    const guardarUsuario = async (data: UpdateUsuarioI) => {
        try {
            console.log(data);
            
            const response = await actualizarUsuario(usuario._id, data);
